...
namespace stardraw
{
    ...
    public:
        ...
        [[nodiscard]] virtual status execute_temp_command_buffer(command_list_handle commands) = 0;
        [[nodiscard]] virtual status create_command_buffer(const std::string_view& name, command_list_handle commands) = 0;
        [[nodiscard]] virtual status delete_command_buffer(const std::string_view& name) = 0;
        [[nodiscard]] virtual status create_objects(descriptor_list_handle descriptors) = 0;
